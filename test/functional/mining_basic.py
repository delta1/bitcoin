...
DEFAULT_BLOCK_MIN_TX_FEE = 100  # default `-blockmintxfee` setting [sat/kvB]
...
class MiningTest(BitcoinTestFramework):
    ...
    def test_blockmintxfee_parameter(self):
        ...
        for blockmintxfee_sat_kvb in (DEFAULT_BLOCK_MIN_TX_FEE, 0, 50, 250, 500, 2500, 5000, 21000, 333333, 2500000):
