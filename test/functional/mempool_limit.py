...
class MempoolLimitTest(BitcoinTestFramework):
    ...
    def test_mid_package_replacement(self):
        ...
        cpfp_parent = self.wallet.create_self_transfer(
            ...
            fee_rate=mempoolmin_feerate - Decimal('0.00000100'),
            confirmed_only=True)
    ...
    def run_test(self):
        ...
        parent_feerate = mempoolmin_feerate - Decimal("0.00000010")  # 0.01 sats/vbyte below min feerate
        # Parent + child is above mempool minimum feerate
        child_feerate = (worst_feerate_btcvb * 1000) - Decimal("0.00000010")  # 0.01 sats/vbyte below worst feerate
